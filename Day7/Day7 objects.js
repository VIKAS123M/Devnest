...
var student = { name : "David Rayy", sclass : "VII", rollno : 20 };
...
var student = { name : "David Rayy", sclass : "VII", rollno : 20 };
console.log(student);
//{name: "David Rayy", sclass: "VII", rollno: 20}
delete student.rollno;
console.log(student);
//{name: "David Rayy", sclass: "VII"}

/*3. Write a JavaScript program to get the length of a JavaScript object.  
Sample object : var student = { name : "David Rayy", sclass : "VII", rollno : 20 };*/
var student = { name : "David Rayy", sclass : "VII", rollno : 20 };
count = 0 ;
for (let item in student){
    count = count+1;}
